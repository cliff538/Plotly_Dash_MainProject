...
# stopped tut at one stock, multiple stocks 'traces' did not work
...
app.layout = html.Div([
    ...
    html.Div([html.H3('Select a start and end date:'),
              dcc.DatePickerRange(id='my_date_picker',
                                  min_date_allowed=datetime(1960, 1, 1),
...
def update_graph(n_clicks, stock_ticker, start_date, end_date):
    ...
    df = web.get_data_tiingo(stock_ticker, start, end, api_key='646d358e70fa9664e2795e73e1ce4ce4c13b5266')
    fig = {'data': [
